...
export default function AboutPart2({ bgcolor, titleImage,subject,srcSvg }) {
  ...
  return (
    <div className={`flex-center md:flex-row ${bgcolor} py-5`}>
      ...
      <motion.div className="h-fit px-5 font-rubik animate__animated animate__fadeInUp text-black/70">
        <div className="grid grid-cols-4 font-comfortaa mx-5 size-fit md:gap-4 select-none">CC</div>
      </motion.div>
    </div>
  );
}
